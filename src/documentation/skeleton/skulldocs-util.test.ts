...
import { skullModulesToTop, resolveDottedName } from "./skulldocs-util";

describe("skullModulesToTop", () => {
  it("pulls modules up", () => {
    const mutated: SkullDocsResponse = {
      microbit: {
        kind: "module",
        fullName: "microbit",
        id: "microbit",
